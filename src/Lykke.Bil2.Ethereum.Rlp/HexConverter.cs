...
using Lykke.Bil2.Ethereum.Rlp.EthTypes;
    ...
    public static class HexConverter
    {
        ...
        public static string GetHexFromObject(object val, bool hexPrefix = false)
        {
            switch (val)
            {
                ...
                case byte[] v: return HexUtil.GetHexFromBytes(v, hexPrefix: hexPrefix);
                default:
        ...
        static string GetZeroStrippedHexFromBytes(ReadOnlySpan<byte> bytes, bool hexPrefix)
        {
            ...
            var hex = HexUtil.GetHexFromBytes(bytes, hexPrefix: hexPrefix);
            if (hexPrefix)
            {
        ...
        public static string GetHex<T>(in T s, bool hexPrefix = false) where T : unmanaged
        {
            ...
            return HexUtil.GetHexFromBytes(MemoryMarshal.AsBytes(span), hexPrefix: hexPrefix);
        }
        ...
        public static TInt HexToInteger<TInt>(string str) where TInt : unmanaged
        {
            ...
            HexUtil.StripHexPrefix(ref strSpan);
            ...
            HexUtil.HexToSpan(strSpan, bytes.Slice(typeSize - byteLen));
        ...
        public static T HexToValue<T>(string str) where T : unmanaged
        {
            ...
            Span<T> span = stackalloc T[1];
            HexUtil.HexToSpan(strSpan, MemoryMarshal.AsBytes(span));
            return span[0];
        }
