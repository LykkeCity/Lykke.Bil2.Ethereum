...
using Lykke.Bil2.Ethereum.Rlp.Cryptography;
using Lykke.Bil2.Ethereum.Rlp.Encoding;
using Lykke.Bil2.Ethereum.Utils;
using Meadow.Core.Cryptography.Ecdsa;

namespace Lykke.Bil2.Ethereum.Rlp.DataTypes.Transactions
{
    public class Transaction : IRLPSerializable
    {
        ...
        public Address GetSenderAddress()
        {
            ...
            byte[] transactionHash = TransactionUtil.GetUnsignedHash(Nonce, 
                GasPrice, 
                StartGas, 
                new Lykke.Bil2.Ethereum.Rlp.EthTypes.Address(To.ToByteArray()), 
                Value, 
                Data, 
                (uint?)ChainID);
        ...
        {
            var sig = TransactionUtil.Sign(privateKey, 
                Nonce, 
                GasPrice, 
                StartGas, 
                new Lykke.Bil2.Ethereum.Rlp.EthTypes.Address(To.ToByteArray()), 
        ...
        {
            return TransactionUtil.Serialize(ECDSA_v,
                ECDSA_r,
                ECDSA_s,
                Nonce, 
                GasPrice,
                StartGas, 
                new Lykke.Bil2.Ethereum.Rlp.EthTypes.Address(To.ToByteArray()), Value, Data);
        }
